...
function wp_bootstrap_starter_scripts() {
	// load bootstrap css
	wp_enqueue_style( 'wp-bootstrap-starter-bootstrap-css-reboot', get_template_directory_uri() . '/inc/assets/css/bootstrap-reboot.min.css' );
	wp_enqueue_style( 'wp-bootstrap-starter-bootstrap-css-grid', get_template_directory_uri() . '/inc/assets/css/bootstrap-grid.css' );

	wp_enqueue_style( 'wp-firststeps-main', get_template_directory_uri() . '/inc/assets/css/main.css?t='.time() );
    ...
    if(get_theme_mod( 'preset_style_setting' ) === 'montserrat-opensans') {
		...
		if(get_theme_mod( 'preset_style_setting' ) === 'firststeps') {
        wp_enqueue_style( 'wp-bootstrap-starter-firststeps', '//fonts.googleapis.com/css?family=Lato:300,300i,400,900|Arvo:400,700' );
    }
